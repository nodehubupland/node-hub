/* Node Hub V1 global language system */
(function () {
  const translations = {
  ...
  document.addEventListener("DOMContentLoaded", function () {
    setTimeout(applyNodeHubLanguage, 100);
    const observer = new MutationObserver(() => {
      if (localStorage.getItem("nodehub-language") === "pt-BR") applyNodeHubLanguage();
    });
